...
router
  .route("/")
  .post(passportJWT, businessCtl.createBusiness)
  .get(passportJWT, businessCtl.getAllBusinesses);
...
router
  ...
  .get(passportJWT, businessCtl.getBusinessByOwner);
...
router
  .route("/services/:id")
  .get(passportJWT, businessCtl.getServicesByBusiness);
router
